...
return {
	 backupTextArea : function(){
	                   text = input.value;
                       textArea.value = text;
},

  deleteTheData     : function deleteTheData() {
                       input.value ="";
                       textArea.value = "";
},
...
var newDate = galleryData.dateFormat(data[startData].date); 
var newStr  = galleryData.descriptionSlice(data[startData].description);
var newName = galleryData. nameToLowerCase(data[startData].name);
...
input.addEventListener ("keyup" , galleryData.backupTextArea);

deleteBatton.addEventListener("click", galleryData.deleteTheData);
